...
// StatusPagesDeleteSubscriberByID - Delete Subscriber By ID
func (s *StatusPagesSubscribers) StatusPagesDeleteSubscriberByID(ctx context.Context, statuspageID string, subscriberID string, opts ...operations.Option) (*operations.StatusPagesDeleteSubscriberByIDResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v4/statuspages/{statuspageID}/subscribers/{subscriberID}", request, nil)
	if err != nil {
	...
	res := &operations.StatusPagesDeleteSubscriberByIDResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.StatusPagesDeleteSubscriberByIDResponseBody
