...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.755.0
...
func New(opts ...SDKOption) *SquadcastSDK {
	sdk := &SquadcastSDK{
		SDKVersion: "1.4.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.4.5 2.755.0 1.0.0 github.com/solarwinds/squadcast-sdk-go",
