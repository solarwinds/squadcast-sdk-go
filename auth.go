...
func newAuth(rootSDK *SquadcastSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Auth {
	return &Auth{
		rootSDK:          rootSDK,
...
// AuthGetAccessToken - Get Access Token
...
func (s *Auth) AuthGetAccessToken(ctx context.Context, xRefreshToken string, opts ...operations.Option) (*operations.AuthGetAccessTokenResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.AuthGetAccessTokenServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/oauth/access-token")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.AuthGetAccessTokenResponseBody
