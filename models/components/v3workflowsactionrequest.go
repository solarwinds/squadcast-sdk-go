...
// #region class-body-v3workflowsactionrequestdata
// #endregion class-body-v3workflowsactionrequestdata
...
// #region class-body-v3workflowsactionrequestsqattachrunbooks
// #endregion class-body-v3workflowsactionrequestsqattachrunbooks
...
type V3WorkflowsActionRequest struct {
	V3WorkflowsActionRequestSqAttachRunbooks *V3WorkflowsActionRequestSqAttachRunbooks `queryParam:"inline" union:"member"`
	V3WorkflowsSqMarkIncidentSLOAffecting    *V3WorkflowsSqMarkIncidentSLOAffecting    `queryParam:"inline" union:"member"`
	V3WorkflowsSqTriggerManualWebhook        *V3WorkflowsSqTriggerManualWebhook        `queryParam:"inline" union:"member"`
	V3WorkflowsUpdateIncidentPriority        *V3WorkflowsUpdateIncidentPriority        `queryParam:"inline" union:"member"`
	V3WorkflowsSqCreateStatusPageIssue       *V3WorkflowsSqCreateStatusPageIssue       `queryParam:"inline" union:"member"`
	V3WorkflowsSqAddIncidentNote             *V3WorkflowsSqAddIncidentNote             `queryParam:"inline" union:"member"`
	V3WorkflowsSlackArchiveChannel           *V3WorkflowsSlackArchiveChannel           `queryParam:"inline" union:"member"`
	V3WorkflowsSqAddCommunicationChannel     *V3WorkflowsSqAddCommunicationChannel     `queryParam:"inline" union:"member"`
	V3WorkflowsSlackMessageChannel           *V3WorkflowsSlackMessageChannel           `queryParam:"inline" union:"member"`
	V3WorkflowsSlackMessageUser              *V3WorkflowsSlackMessageUser              `queryParam:"inline" union:"member"`
	V3WorkflowsSqMakeHTTPCall                *V3WorkflowsSqMakeHTTPCall                `queryParam:"inline" union:"member"`
	V3WorkflowsSlackCreateIncidentChannel    *V3WorkflowsSlackCreateIncidentChannel    `queryParam:"inline" union:"member"`
	V3WorkflowsJiraCreateTicket              *V3WorkflowsJiraCreateTicket              `queryParam:"inline" union:"member"`
	V3WorkflowsMsTeamsMessageChannel         *V3WorkflowsMsTeamsMessageChannel         `queryParam:"inline" union:"member"`
	V3WorkflowsMsTeamsMessageUser            *V3WorkflowsMsTeamsMessageUser            `queryParam:"inline" union:"member"`
	V3WorkflowsSqSendEmail                   *V3WorkflowsSqSendEmail                   `queryParam:"inline" union:"member"`
	V3WorkflowsMsTeamsCreateMeetingLink      *V3WorkflowsMsTeamsCreateMeetingLink      `queryParam:"inline" union:"member"`
