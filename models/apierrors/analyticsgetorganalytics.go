...
type BadRequest struct {
	ResponseBodyError1 *ResponseBodyError1 `queryParam:"inline" union:"member"`
	ResponseBodyError2 *ResponseBodyError2 `queryParam:"inline" union:"member"`
